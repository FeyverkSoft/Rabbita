...
{
    public static IServiceCollection AddEventProcessor(this IServiceCollection services, [NotNull] Action<IGlobalOptions> options,
        [NotNull] Action<IEventHandlerRegistry> action)
    {
        if (action == null)
